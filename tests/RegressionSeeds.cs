...
public static class RegressionSeeds
{
    ...
    public static readonly Entry[] All =
    {
        ...
        new(57, 5, "a gap and four committed banked turns with a ridge line"),
        new(4, 8, "a launch ramp, one banked turn and a ridge line"),
        new(34, 6, "a gap, a banked turn and a ridge line"),
        ...
        new(1, 8, "Dune Sea: a three-crest train followed by a launch ramp (once the too-narrow launch window's failure)", Rushcore.Generation.TerrainArchetype.DuneSea),
    };
}

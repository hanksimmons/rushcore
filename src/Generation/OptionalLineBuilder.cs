...
public static class OptionalLineBuilder
{
    ...
    /// <summary>A ridge section clears every feature straight: the two corridors' falloffs overlap, and a
    /// ridge riding the plain profile beside a crest, a pit or a lip would tilt the primary's outer width.</summary>
